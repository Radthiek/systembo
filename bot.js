...
client.channels.find('id', '507261664471678976').setName("༺");
client.channels.find('id', '507261664471678976').setName("༺W");
client.channels.find('id', '507261664471678976').setName("༺We");
client.channels.find('id', '507261664471678976').setName("༺Wel");
client.channels.find('id', '507261664471678976').setName("༺Welc");
client.channels.find('id', '507261664471678976').setName("༺Welco");
client.channels.find('id', '507261664471678976').setName("༺Welcom");
client.channels.find('id', '507261664471678976').setName("༺Welcome");
client.channels.find('id', '507261664471678976').setName("༺Welcome T");
client.channels.find('id', '507261664471678976').setName("༺Welcome To");
client.channels.find('id', '507261664471678976').setName("༺Welcome To R");
client.channels.find('id', '507261664471678976').setName("༺Welcome To RA");
client.channels.find('id', '507261664471678976').setName("༺Welcome To RAD༻");
client.channels.find('id', '507261664471678976').setName("༺Welcome To RAD༻🌹");
  }, 3000);
});
 ...
 client.on("ready", async () => {
  ...
  bot.user.setActivity("System - " + botconfig.prefix + "help", {type: "WATCHING"});
...
client.on('voiceStateUpdate', (o,n) => {
    if (o.voiceChannel && !n.voiceChannel) {
        ss-=1
        n.guild.channels.get("507294142313791499").edit({
...
client.on("ready", () => {
    client.guilds.get("507294142313791499").members.forEach(m => {
        if (m.voiceChannel) {
            ss+=1
        };
        client.channels.get("507294142313791499").edit({
            name : "Voice Online : [" + ss+ "]"
        })
    });
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=505444781334200321&permissions=8&scope=bot`)
